                                        ...
                                        <div class="row">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <input name="addr[billing][first_name]"
                                                                   placeholder="First Name"/>
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                                            <input name="addr[billing][last_name]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input name="addr[billing][phone_number]"
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input name="addr[billing][street_address]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input name="addr[billing][postal_code]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <input name="addr[billing][state]" class="form-control" placeholder="State"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <input name="addr[shipping][first_name]"
                                                                   placeholder="First Name"/>
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                                            <input name="addr[shipping][last_name]"
                                                                   placeholder="Last Name"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <input name="addr[shipping][email]"
